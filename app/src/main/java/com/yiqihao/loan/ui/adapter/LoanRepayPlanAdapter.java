...
public class LoanRepayPlanAdapter extends BaseAdapter {
	...
	public LoanRepayPlanAdapter(Context context) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		CharSequence text = mContext.getString(R.string.loan_repay_plan_content, model.getNo(), model
				.getSum_no(), StringUtils.formatMoneyWan(model.getMoney()), StringUtils.formatMoney(String.valueOf(Double.valueOf(model.getAmount())-Double.valueOf(model.getMoney()))), 0);
