...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	private boolean clickText = true;
	...
	private int tabTextColor = 0xff82858b;
	private int selectedTabTextColor = 0x87000000;
	...
	public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
		...
		clickText = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstsTextClick, clickText);
