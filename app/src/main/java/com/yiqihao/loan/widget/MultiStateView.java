...
public class MultiStateView extends FrameLayout {
    ...
    @Override
    protected boolean addViewInLayout(View child, int index, ViewGroup.LayoutParams params, boolean
     ...
     * @return The {@link View} associated with the {@link com.kennyc.view.MultiStateView.ViewState}, null if no view
     * is present
     */
    @Nullable
        ...
        switch (mViewState) {
            ...
            default:
                if (mContentView == null) {
                    // Should never happen, the view should throw an exception if no content view is present upon
                    // creation
